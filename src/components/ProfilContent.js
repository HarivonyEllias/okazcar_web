...
import '../assets/css/ProfilContent.css';
                ...
                <div className="row align-items-center flex-row-reverse">
                    <div className="col-lg-6">
                        <div className="about-text go-to">
                            <h3 className="dark-color">Harivony Ellias</h3>
                    ...
                    <div className="row">
                        <div className="col-6 col-lg-3">
                            <div className="count-data text-center">
                                ...
                                <p className="m-0px font-w-600">Favoris</p>{/** contacter */}
                            </div>
                        </div>
                        <div className="col-6 col-lg-3">
                            <div className="count-data text-center">
                                {/* <h6 className="count h2" data-to="150" data-speed="150">150</h6> */}
                                <p className="m-0px font-w-600">Historique</p>
                            </div>
                        </div>
                        <div className="col-6 col-lg-3">
                            <div className="count-data text-center">
                                {/* <h6 className="count h2" data-to="850" data-speed="850">850</h6> */}
                                <p className="m-0px font-w-600">Mes annonces</p>{/** vendu */}
                            </div>
                        </div>
                        <div className="col-6 col-lg-3">
                            <div className="count-data text-center">
                                {/* <h6 className="count h2" data-to="190" data-speed="190">190</h6> */}
                                <p className="m-0px font-w-600">Annonce en attente</p>
                            </div>
                        </div>
                    </div>
                </div>
